...
label event2_start:
    $ persistent.event2_reached = True
...
label event2_drunk:
    ...
    menu:
        "We will drink the blood of our enemies.":
            ...
            menu:
                "The NWI Guild":
                    ...
                    $ persistent.event2_game_overs[0] = True
                    jump game_over
        ...
        "Let me show you the magical invention of alcohol":
            ...
            $ persistent.event2_game_overs[1] = True
            jump game_over
        ...
        "Let's go to starbucks":
            ...
            #show umbreon head:
            #    anchor (0.6, 0.72) alpha 0.25 xpos 0.5 ypos 0.5
            u "To preserve normality, I'm gonna delete you now.{fast}"
            u "Bye bye!{fast}"
            window auto

            $ persistent.ending_0_reached = True
...
label event2_hobbies:
    ...
    menu:
        "I love those guild hosted tournaments!":
            ...
            menu:
                ...
                "Um... Umbreon the Shadow Cleric?":
                    ...
                    $ persistent.event2_game_overs[2] = True
                    jump game_over
                ...
                "Flareon the Fluff Ball?":
                    ...
                    $ persistent.event2_game_overs[3] = True
                    jump game_over
        ...
        "I’m not interested in tournaments.":
            ...
            $ persistent.event2_game_overs[4] = True
            call game_over(False) from _call_game_over_1
...
label event2_present:
    ...
    if(persistent.presents == 0):
        $ persistent.presents = 1
    $ persistent.event2_game_overs[5] = True
    jump game_over